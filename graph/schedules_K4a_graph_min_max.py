...
# 1. Dane wejściowe
data = open("outputs_2/schedules_K4a_t10_min_max_avg5.csv", "r", encoding="utf-16").read()
times = 10
...
ax.set_ylim(100, 1000) # Ograniczenie osi Y do 6 sekund
ax.set_xticks(x)
ax.set_xticklabels(chunk_order, fontsize=11)

ax.set_title('Kod K4a - porównanie prędkości przetwarzania dla różnych podziałów pracy', fontsize=14, pad=20, weight='bold')

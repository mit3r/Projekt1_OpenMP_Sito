...
# 1. Dane wejściowe
data = open("outputs/schedules_K4_t10_min_max.csv", "r", encoding="utf-16").read()
...
ax.set_ylim(0.5, 5) # Ograniczenie osi Y do 6 sekund
ax.set_xticks(x)
ax.set_xticklabels(chunk_order, fontsize=11)

ax.set_title('Kod K4 - porównanie czasów wykonania dla różnych podziałów pracy', fontsize=14, pad=20, weight='bold')
